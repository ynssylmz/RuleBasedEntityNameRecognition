...
namespace KuralTabanliVarlikIsmiTanimaProgrami
{
    class SozlukSinif:TemelSinif
    {
        ...
        public string[] sozluk_Organizasyon_IsimdenSonra = new string[100];
        public string[] sozluk_Organizasyon_IsminIcinde = new string[100];
        public string[] sozluk_Unvan_IsimdenOnce = new string[100];
        public string[] sozluk_Unvan_IsimdenSonra = new string[100];
        public string[] sozluk_Yer_IsimdenOnce = new string[100];
        public string[] sozluk_Yer_IsimdenSonra = new string[100];
        ...
        public void SozlukleriAl()
        {
            ...
            {
                //----------------------------------------------------------
                oku = new StreamReader(dosya_SozlukOrganizasyon_IsimdenSonra, Encoding.GetEncoding("iso-8859-9"), false);
                ...
                oku.Close();
                //---------------------------------------------------------
                oku = new StreamReader(dosya_SozlukOrganizasyon_IsminIcinde, Encoding.GetEncoding("iso-8859-9"), false);
                while ((sozluk = oku.ReadLine()) != null)
                {
                ...
                oku.Close();
                //---------------------------------------------------------
                oku = new StreamReader(dosya_SozlukUnvan_IsimdenOnce, Encoding.GetEncoding("iso-8859-9"), false);
                while ((sozluk = oku.ReadLine()) != null)
                {
                ...
                oku.Close();
                //---------------------------------------------------------
                oku = new StreamReader(dosya_SozlukUnvan_IsimdenSonra, Encoding.GetEncoding("iso-8859-9"), false);
                while ((sozluk = oku.ReadLine()) != null)
                {
